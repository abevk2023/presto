...
import com.facebook.presto.spi.FunctionPlugin;
...
public class FunctionPluginManager
{
    ...
    private static final String FUNCTION_PLUGIN_SERVICES_FILE = "META-INF/services/" + FunctionPlugin.class.getName();
            ...
            throws Exception
    {
        ...
        try (ThreadContextClassLoader ignored = new ThreadContextClassLoader(pluginClassLoader)) {
            loadPlugin(pluginClassLoader, FunctionPlugin.class);
        }
    ...
    private void loadPlugin(URLClassLoader pluginClassLoader, Class<?> clazz)
    {
        ...
        for (Object plugin : plugins) {
            ...
            if (plugin instanceof FunctionPlugin) {
                installFunctionPlugin((FunctionPlugin) plugin);
            }
            else {
    ...
    public void installFunctionPlugin(FunctionPlugin plugin)
    {
        for (FunctionNamespaceManagerFactory functionNamespaceManagerFactory : plugin.getFunctionNamespaceManagerFactories()) {
            ...
            functionAndTypeManager.addFunctionNamespaceFactory(functionNamespaceManagerFactory);
        }
    }
            ...
            throws Exception
    {
        ...
        processPlugins(artifact, classLoader, FUNCTION_PLUGIN_SERVICES_FILE, CoordinatorPlugin.class.getName());
